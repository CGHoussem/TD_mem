...
set title "L2 cache"
plot "load/load_L2.dat" u 2:xtic(1) t "Intel Core i5-8250U"

set title "L3 cache"
plot "load/load_L3.dat" u 2:xtic(1) t "Intel Core i5-8250U"

set title "DRAM"
plot "load/load_DRAM.dat" u 2:xtic(1) t "Intel Core i5-8250U"
